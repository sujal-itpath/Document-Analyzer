...
from app.api.endpoints import upload, chat, auth, auth_google, auth_jira, jira, workspaces, projects, test_case
...
api_router.include_router(test_case.router, prefix="/test-cases", tags=["test_cases"])
