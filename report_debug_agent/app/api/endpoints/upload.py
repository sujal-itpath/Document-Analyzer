...
async def upload_documents(
    ...
    try:
        ...
        setup_vector_store(file_paths, overwrite=False)
...
async def sync_google_doc(
    ...
    try:
        ...
        # Determine filename
        filename = f"{name}.docx" if name else f"GoogleDoc_{doc_id}.docx"
        ...
        # Fetch the binary docx content from Google Drive API
        docx_content = fetch_google_doc_docx(current_user.id, doc_id)
